...
/// Mission Photo Not Allowed Table
class MissionPhotoNotAllowedTable
    extends SupabaseTable<MissionPhotoNotAllowedRow> {
  /// Table Name
  @override
  String get tableName => 'mission_photo_not_allowed';

  /// Create a [MissionPhotoNotAllowedRow] from the [data] provided
  @override
  MissionPhotoNotAllowedRow createRow(Map<String, dynamic> data) =>
      MissionPhotoNotAllowedRow.fromJson(data);
}

/// Mission Photo Not Allowed Row
class MissionPhotoNotAllowedRow extends SupabaseDataRow {
  /// Mission Photo Not Allowed Row
  MissionPhotoNotAllowedRow({
  ...
  /// Mission Photo Not Allowed Row
  const MissionPhotoNotAllowedRow._(super.data);

  /// Create Mission Photo Not Allowed Row from a [data] map
  factory MissionPhotoNotAllowedRow.fromJson(Map<String, dynamic> data) =>
      MissionPhotoNotAllowedRow._(data.cleaned);
  ...
  @override
  SupabaseTable get table => MissionPhotoNotAllowedTable();
  ...
  /// Make a copy of the current [MissionPhotoNotAllowedRow]
  /// overriding the provided fields
  MissionPhotoNotAllowedRow copyWith({
    String? folderPath,
    String? fileName,
    String? mission,
    String? id,
    ...
    String? createdBy,
    int? order,
  }) => MissionPhotoNotAllowedRow.fromJson({
...
/// Tag: v2
/// Date: 2026-03-20 19:41:33.387368
