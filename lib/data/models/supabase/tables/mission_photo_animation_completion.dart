...
/// Mission Photo Animation Completion Table
class MissionPhotoAnimationCompletionTable
    extends SupabaseTable<MissionPhotoAnimationCompletionRow> {
  /// Table Name
  @override
  String get tableName => 'mission_photo_animation_completion';

  /// Create a [MissionPhotoAnimationCompletionRow] from the [data] provided
  @override
  MissionPhotoAnimationCompletionRow createRow(Map<String, dynamic> data) =>
      MissionPhotoAnimationCompletionRow.fromJson(data);
}

/// Mission Photo Animation Completion Row
class MissionPhotoAnimationCompletionRow extends SupabaseDataRow {
  /// Mission Photo Animation Completion Row
  MissionPhotoAnimationCompletionRow({
  ...
  /// Mission Photo Animation Completion Row
  const MissionPhotoAnimationCompletionRow._(super.data);

  /// Create Mission Photo Animation Completion Row from a [data] map
  factory MissionPhotoAnimationCompletionRow.fromJson(
    Map<String, dynamic> data,
  ) => MissionPhotoAnimationCompletionRow._(data.cleaned);
  ...
  @override
  SupabaseTable get table => MissionPhotoAnimationCompletionTable();
  ...
  /// Make a copy of the current [MissionPhotoAnimationCompletionRow]
  /// overriding the provided fields
  MissionPhotoAnimationCompletionRow copyWith({
    String? folderPath,
    String? fileName,
    String? mission,
    String? id,
    ...
    String? createdBy,
    int? order,
  }) => MissionPhotoAnimationCompletionRow.fromJson({
...
/// Tag: v2
/// Date: 2026-02-04 11:46:32.460749
