...
/// "적립 내역 확인하기" dialog – shows earning/point accumulation history
/// for a selected period (date range, summary, list of earning entries).
class EarningHistoryDialog extends StatelessWidget {
  const EarningHistoryDialog({super.key});
