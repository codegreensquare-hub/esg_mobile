-- Fix trigger: mission.cost was renamed to cost_start/cost_end.
-- Use cost_end from mission for mission_participation.cost.
...
DECLARE
    ...
    v_click_id uuid;
BEGIN
    -- Get award_points and cost_end from the related mission
    SELECT award_points, cost_end INTO v_mission_award_points, v_mission_cost
    FROM mission
